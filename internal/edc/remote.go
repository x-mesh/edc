...
func runRemoteRun(group string, args []string, version string) int {
	...
	set.BoolVar(&dryRun, "n", false, T("command.remote.option.dry_run"))
	set.BoolVar(&list, "list", false, T("command.remote.option.list"))
	set.BoolVar(&list, "l", false, T("command.remote.option.list"))
